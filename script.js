...
function renderHeader() {
  ...
  <img src="day-and-night.png" alt="Toggle Dark Mode" class="h-6 w-6" />
        ...
        <button class="p-2 rounded hover:bg-white hover:bg-opacity-20 ml-2" onclick="showPopup('Carrello non implementato', 'blue')">
  <img src="shop.png" alt="Shop Icon" class="h-6 w-6" />
</button>
